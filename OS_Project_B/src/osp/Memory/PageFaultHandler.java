...
public class PageFaultHandler extends IflPageFaultHandler
{
    ...
    */
	 ...
	 * Updating a page table: To indicate that a page P is no longer valid, one
		...
		following:
			â€“ use setFrame() to set the frame of P to F
			â€“ use setPage() to set F â€™️s page to P
			â€“ set the Pâ€™️s validity flag correctly
			â€“ set the dirty and reference flags in F appropriately.
